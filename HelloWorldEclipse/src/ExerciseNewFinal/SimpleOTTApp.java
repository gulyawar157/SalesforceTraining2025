...
class PremiumPlan extends Plan {
    ...
    public boolean canStreamOn(String device) { return true; }
}
...
// --- OTT Platform Class (uses maps passed from outside) ---
class OTTPlatform {
    private final Map<String, User> users;
    private final Map<Integer, Content> contents;

    public OTTPlatform(Map<String, User> users, Map<Integer, Content> contents) {
        this.users = users;
...
public class SimpleOTTApp {
    public static void main(String[] args) {
        //* Initialize maps here instead of inside OTTPlatform
        Map<String, User> users = new HashMap<>();
        Map<Integer, Content> contents = new LinkedHashMap<>();
        ...
        OTTPlatform platform = new OTTPlatform(users, contents);
